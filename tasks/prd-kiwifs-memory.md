...
- [ ] Measured retrieval latency/context usage and extraction call volume meet T02 budgets. _NOT measured in chunk 1._
- [ ] Retrieval fixture expectations and observation coverage criteria are documented and met; no invented quality percentages. _NOT done in chunk 1._
- [ ] Long-session test demonstrates bounded local state and no active handles after shutdown. _T19 chunk 1 partial: bounded outbox state file + closed-store refusal; full long-session handle audit pending._
